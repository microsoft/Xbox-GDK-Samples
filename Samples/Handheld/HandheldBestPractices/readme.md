...
Build with Visual Studio 2022 (or greater) for x64 or ARM64 and copy to a handheld device.
...
- LB + RB + View + Menu *or* Alt+F4: Exit
- LB + RB + Y *or* F2: Toggle Light/Dark theme
...
- 05/2026 -- Added ARM64 build configurations
