...
LPCWSTR g_szAppName = L"ProcessorInfo";
...
int WINAPI SampleMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
    ...
    // Register class and create window
    {
        ...
        wcex.lpszClassName = L"ProcessorInfoWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"ProcessorInfoWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
