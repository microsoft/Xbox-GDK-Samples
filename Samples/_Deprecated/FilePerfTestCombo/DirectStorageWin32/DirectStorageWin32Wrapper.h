...
namespace DirectStorageWin32Wrapper
{
    ...
    namespace Internal
    {
        ...
        /// \details Internal container for IDStorageFileX data needs
        //////////////////////////////////////////////////////////////////////////
        class DirectStorageFile final : public IDStorageFileX
        {
        ...
        /// \details Internal representation of an IDStorageStatusArrayX
        //////////////////////////////////////////////////////////////////////////
        class DirectStorageStatusArray final : public IDStorageStatusArrayX
        {
            friend class DirectStorageFactory;
        private:
        ...
        public:
            ...
            void MarkState(uint32_t index, bool complete, HRESULT error);	// Internal only function, not part of IDStorageStatusArrayX
        ...
        /// \details Internal representation of an IDStorageQueueX
        ...
        //////////////////////////////////////////////////////////////////////////
        class DirectStorageQueue final : public IDStorageQueueX
        {
            friend class DirectStorageFactory;
        public:
        ...
        private:
            static const uint32_t c_fileAlignment = 4096;
            ...
            public:
                ...
                bool IsRequestValidForReading() const
                {
                ...
                bool IsFenceEntry() const { return entryType == EntryType::FENCE_ENTRY; }
                bool IsStatusEntry() const { return entryType == EntryType::STATUS_ENTRY; }
                bool IsRequestEntry() const { return entryType == EntryType::REQUEST_ENTRY; }
                bool IsBlank() const { return currentState == State::STATE_BLANK; }
                bool IsError() const { return currentState == State::STATE_ERROR; }
                bool IsPending() const { return currentState == State::STATE_PENDING; }
                bool IsSubmitted() const { return currentState == State::STATE_SUBMITTED; }
                bool IsReading() const { return currentState == State::STATE_READING; }
                bool IsCancellable() const { return (currentState == State::STATE_PENDING) || (currentState == State::STATE_SUBMITTED); }
                bool IsReadyDecompression() const { return currentState == State::STATE_READY_DECOMPRESS; }
                bool IsCompressed() const { assert(IsRequestEntry()); return (request.Options.ZlibDecompress) || (request.Options.BcpackMode != 0); }
            };
            struct EntryList
            {
            private:
        ...
        public:
            ...
            void EnqueueStatus(IDStorageStatusArrayX* statusArray, UINT32 index) override;
        ...
        /// \details Internal representation of an IDStorageFactoryX
        ...
        //////////////////////////////////////////////////////////////////////////
        class DirectStorageFactory final : public IDStorageFactoryX
        {
        public:
            ...
            static const uint32_t c_realtimePriorityThreshold = 1;			// Total number of requests submitted before submitting one at this priority
            static const uint32_t c_highPriorityThreshold = 1;				// Total number of requests submitted before submitting one at this priority
            static const uint32_t c_mediumPriorityThreshold = 10;			// This is handled as the mod of the total requests submitted and this value is 0
            static const uint32_t c_lowPriorityThreshold = 100;

            static const uint32_t c_maxAsyncRequestsInFlight = 32;			// Not all requests are submitted to Win32 at once, a max of this amount is allowed to be in flight at a time
            static const uint32_t c_managementThreadSleepTimeMS = 2;		// Heartbeat for the management thread, it can be kicked with m_kickThreadEvent
            static const uint32_t c_decompressionThreadSleepTimeMS = 2;		// Heartbeat for the decompression threads
            static const uint32_t c_maxOpenFiles = 5000;					// Used to preallocate the array of open files, TODO: Check if this number is reasonable, could be larger
            static const uint32_t c_maxQueues = 100;						// Used to preallocate the array of queue object, TODO: Check if this number is reasonable, could be larger
            static const uint64_t c_initialStagingBufferSize = 32ULL * 1024 * 1024;	// Staging buffer heap is created initially at this size.
                                                                                    // However the heap can grow beyond this size due to limitiations in Win32 Heap objects
            static const uint32_t c_numDecompressionThreads = 5;
