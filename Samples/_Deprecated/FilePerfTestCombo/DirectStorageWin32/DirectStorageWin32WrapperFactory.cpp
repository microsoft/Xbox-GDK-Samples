...
extern "C" {
    ...
    /// \details Instantiation of DStorageGetFactory function from Microsoft GDK DirectStorage spec
    //////////////////////////////////////////////////////////////////////////
    HRESULT DStorageGetFactory(REFIID riid, void** ppv)
    {
        if (riid != __uuidof(IDStorageFactoryX))
...
/// \details Instantiation of IDStorageFactoryX::OpenFile function
//////////////////////////////////////////////////////////////////////////
#pragma warning(push)
...
HRESULT DirectStorageFactory::OpenFile(_In_z_ const WCHAR* fileName, REFIID riid, _COM_Outptr_ void** ppv)
{
    ...
    *ppv = nullptr;
    ...
    if (riid != __uuidof(IDStorageFileX))
        return HRESULT_FROM_WIN32(ERROR_INVALID_PARAMETER);
    if (fileName == nullptr)
        return HRESULT_FROM_WIN32(ERROR_INVALID_PARAMETER);
...
/// \details Instantiation of IDStorageFactoryX::CreateQueue function
//////////////////////////////////////////////////////////////////////////
...
/// \details Instantiation of IDStorageFactoryX::CreateStatusArray function
//////////////////////////////////////////////////////////////////////////
HRESULT DirectStorageFactory::CreateStatusArray(UINT32 capacity, PCSTR name, REFIID riid, _COM_Outptr_ void** ppv)
{
    ...
    *ppv = nullptr;
    ...
    if (riid != __uuidof(IDStorageStatusArrayX))
        return HRESULT_FROM_WIN32(ERROR_INVALID_PARAMETER);
