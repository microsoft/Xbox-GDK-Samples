...
LPCWSTR g_szAppName = L"FilePerfTestCombo";
...
int SampleMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"FilePerfTestComboWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"FilePerfTestComboWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
