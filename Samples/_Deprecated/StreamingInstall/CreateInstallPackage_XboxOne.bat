...
echo Copying over the chunks.xml file for the XboxOne device family
copy /b Chunks_XboxOne.xml .\Gaming.Xbox.XboxOne.x64\Layout\Image\Loose\Chunks.xml

echo Copying over the MicrosoftGame.config file for the XboxOne device family
