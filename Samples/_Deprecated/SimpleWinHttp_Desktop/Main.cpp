...
LPCWSTR g_szAppName = L"SimpleWinHttp_Desktop";
...
int SampleMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
    ...
    // Register class and create window
    {
        ...
        wcex.lpszClassName = L"SimpleWinHttp_DesktopWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"SimpleWinHttp_DesktopWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
            CW_USEDEFAULT, CW_USEDEFAULT, rc.right - rc.left, rc.bottom - rc.top, nullptr, nullptr, hInstance,
            nullptr);
        // Change to CreateWindowExW(WS_EX_TOPMOST, L"SimpleWinHttp_DesktopWindowClass", g_szAppName, WS_POPUP,
