...
LPCWSTR g_szAppName = L"InGameStore_Desktop";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
    ...
    // Register class and create window
    {
        ...
        wcex.lpszClassName = L"InGameStore_DesktopWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"InGameStore_DesktopWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
            CW_USEDEFAULT, CW_USEDEFAULT, rc.right - rc.left, rc.bottom - rc.top, nullptr, nullptr, hInstance,
            nullptr);
        // Change to CreateWindowExW(WS_EX_TOPMOST, L"InGameStore_DesktopWindowClass", g_szAppName, WS_POPUP,
