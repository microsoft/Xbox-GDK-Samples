...
此示例与 Microsoft 游戏开发工具包预览版（2020 年 2 月）兼容
...
为电脑进行构建时，选择 Gaming.Desktop.x64 平台配置。

有关详细信息，请参阅 GDK 文档中的"运行示例"。

# 使用示例

至少需要两名参与者，每人配备一个麦克风和扬声器。 可以是
Kinect、单声道耳机和立体声耳机、电视扬声器等。
每个参与者都需要一个有效的 Xbox Live
用户，如果他们是朋友，这将有所帮助。 应为 XDKS.1 沙盒配置电脑、Xbox
和用户帐户。
