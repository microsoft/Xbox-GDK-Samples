...
*이 샘플은 Microsoft 게임 개발 키트 미리 보기(2020년 2월)와 호환됩니다.*
...
PC용으로 빌드할 경우 Gaming.Desktop.x64 플랫폼 구성을 선택합니다.

*자세한 내용은 GDK 문서에서* 샘플 실행하기*를 참조하세요.*

# 샘플 사용

마이크와 스피커를 보유한 둘 이상의 참가자가 필요합니다. Kinect, 모노,
스테레오 헤드셋, TV 스피커 등이 있습니다. 각 참가자에 유효한 Xbox Live
사용자가 필요하며 둘이 친구면 도움이 됩니다. XDKS.1 샌드박스에 맞게 PC,
Xbox 및 사용자 계정을 구성해야 합니다.
