...
LPCWSTR g_szAppName = L"GameSaveFilesCombo";
...
int SampleMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"GameSaveFilesWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"GameSaveFilesWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
