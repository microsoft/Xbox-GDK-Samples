...
LPCWSTR g_szAppName = L"DefaultExperience";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"DefaultExperienceWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"DefaultExperienceWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
