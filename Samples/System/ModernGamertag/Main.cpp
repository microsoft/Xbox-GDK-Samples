...
LPCWSTR g_szAppName = L"ModernGamerTag";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"ModernGamerTagWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"ModernGamerTagWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
