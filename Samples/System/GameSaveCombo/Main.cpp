...
LPCWSTR g_szAppName = L"GameSaveCombo";
...
int SampleMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"GameSaveComboWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"GameSaveComboWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
