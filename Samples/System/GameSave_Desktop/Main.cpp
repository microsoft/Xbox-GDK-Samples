...
// Main.cpp
//
// Entry point for Microsoft Game Development Kit for Desktop
//
...
namespace
{
    std::unique_ptr<GameSaveSample::Sample> g_sample;
};

LPCWSTR g_szAppName = L"GameSave_Desktop";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
    ...
    g_sample = std::make_unique<GameSaveSample::Sample>();
    ...
    // Register class and create window
    {
        ...
        wcex.lpszClassName = L"GameSave_DesktopWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"GameSave_DesktopWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
            CW_USEDEFAULT, CW_USEDEFAULT, rc.right - rc.left, rc.bottom - rc.top, nullptr, nullptr, hInstance,
            nullptr);
        // Change to CreateWindowExW(WS_EX_TOPMOST, L"GameSave_DesktopWindowClass", g_szAppName, WS_POPUP,
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    auto sample = reinterpret_cast<GameSaveSample::Sample*>(GetWindowLongPtr(hWnd, GWLP_USERDATA));
    ...
    case WM_SYSKEYUP:
        ...
        if (message == WM_KEYUP)
        {
            g_sample->OnKeyUp(wParam, lParam);
        }
        else if (message == WM_KEYDOWN)
        {
            g_sample->OnKeyDown(wParam, lParam);
        }
        break;
