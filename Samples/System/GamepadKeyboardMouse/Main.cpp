...
LPCWSTR g_szAppName = L"Gamepad Keyboard Mouse";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"GamepadKeyboardMouseWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"GamepadKeyboardMouseWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_MOUSEMOVE:
        if (sample)
        {
            ...
            // If you have a 4K back buffer, be aware that you will need to scale your coordinates
            int mx = static_cast<int>(LOWORD(lParam)); // GET_X_LPARAM(lParam);
            int my = static_cast<int>(HIWORD(lParam)); // GET_X_LPARAM(lParam);
