...
//
// NOTE: This has been modified to pass the command line arguments to the Sample constructor.
//
...
int SampleMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
    ...
    g_sample = std::make_unique<Sample>(lpCmdLine);
    ...
    PAPPSTATE_REGISTRATION hPLM = {};
    {
        ...
        wcex.lpszClassName = u8"UserManagementWindowClass";
        wcex.hbrBackground = (HBRUSH)(COLOR_WINDOW + 1);
        if (!RegisterClassExA(&wcex))
            return 1;

        // Create window
        HWND hwnd = CreateWindowExA(0, u8"UserManagementWindowClass", u8"UserManagement", WS_OVERLAPPEDWINDOW,
