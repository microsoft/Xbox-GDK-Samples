...
namespace ATG
{
    ...
    inline static HANDLE safe_handle(HANDLE h) noexcept { return (h == INVALID_HANDLE_VALUE) ? nullptr : h; }
...
HRESULT ATG::LoadWAVAudioInMemory(
...
//-------------------------------------------------------------------------------------
_Use_decl_annotations_
HRESULT ATG::LoadWAVAudioFromFile(
...
//-------------------------------------------------------------------------------------
_Use_decl_annotations_
HRESULT ATG::LoadWAVAudioInMemoryEx(
    const uint8_t* wavData,
    size_t wavDataSize,
...
//-------------------------------------------------------------------------------------
_Use_decl_annotations_
HRESULT ATG::LoadWAVAudioFromFileEx(
    const wchar_t* szFileName,
    std::unique_ptr<uint8_t[]>& wavData,
    WAVData& result) noexcept
{
