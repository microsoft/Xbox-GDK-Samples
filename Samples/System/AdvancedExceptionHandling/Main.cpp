...
LPCWSTR g_szAppName = L"AdvancedExceptionHandling";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"AdvancedExceptionHandlingWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"AdvancedExceptionHandlingWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
