...
LPCWSTR g_szAppName = L"EnumerateThreads";
...
int SampleMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"FutexComboWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"FutexComboWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
