...
LPCWSTR g_szAppName = L"GamepadVibration";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"GamepadVibrationWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"GamepadVibrationWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
