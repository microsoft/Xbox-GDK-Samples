...
void Sample::DrawHelpText(DirectX::XMFLOAT2& pos, ATG::MemoryBankDemoTests whichTest)
{
    static const wchar_t *helpText[] = {
        ...
        L"    Allocates a block of memory through XMemVirtualAlloc and then reads a binary tree into the memory block.",
        ...
        L"    Two memory banks are created through XMemVirtualAlloc, Bank A and Bank B.",
