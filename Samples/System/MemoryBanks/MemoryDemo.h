...
namespace ATG
{
	...
	{
	private:
		static constexpr size_t  c_memoryBankSize = 128 * 1024;
		static constexpr uint32_t c_maxTestDataTreeLevel = 10;
		static constexpr size_t  c_testDataAllocatorSize = 1 << c_maxTestDataTreeLevel;
		const static char *c_fixedTestDataFilename;
		const static char *c_randomTestDataFilename;
