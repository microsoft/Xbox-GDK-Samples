...
#if defined(_GAMING_DESKTOP) && defined(USING_D3D12_AGILITY_SDK)
extern "C"
{
...
LPCWSTR g_szAppName = L"GameInputInterfacing";
...
int WINAPI SampleMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"GameInputInterfacingWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"GameInputInterfacingWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
