...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE /*hPrevInstance*/, _In_ LPWSTR /*lpCmdLine*/, _In_ int /*nCmdShow*/)
{
    ...
    if (FAILED(hr))
    {
        ...
        {
            std::ignore = MessageBoxW(nullptr, L"Game Runtime is not installed on this system or needs updating.", L"Lighting", MB_ICONERROR | MB_OK);
        }
#endif
        return 1;
    }
    ...
    WNDCLASSEXW wc = { sizeof(wc), CS_CLASSDC, WndProc, 0L, 0L, hInstance, nullptr, nullptr, nullptr, nullptr, L"Lighting", nullptr };
    RegisterClassExW(&wc);

    HWND hWnd = CreateWindowW(wc.lpszClassName, L"Lighting", WS_OVERLAPPEDWINDOW,
    ...
    // TODO: To enable telemetry, uncomment these lines, add Kits\ATGTelemetry\GDK
    // to AdditionalIncludeDirectories, add ATGTelemetry.h as ClInclude and
    // ATGTelemetry.cpp as ClCompile to the .vcxproj, and add the required
    // Privacy Statement section to readme.md.
