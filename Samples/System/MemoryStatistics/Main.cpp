...
LPCWSTR g_szAppName = L"MemoryStatistics";
...
int SampleMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"MemoryStatisticsWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"MemoryStatisticsWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
