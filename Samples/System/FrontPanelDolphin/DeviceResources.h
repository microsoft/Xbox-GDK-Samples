...
//
// This version has been modified for access to all backbuffer rendertargets
//
...
namespace DX
{
    ...
    public:
        ...
        ID3D12Resource*             GetRenderTarget(unsigned int backbufferIndex) const noexcept { return m_renderTargets[backbufferIndex].Get(); }
