...
#include "pch.h"
#include "InMemoryZLibDecompression.h"
...
bool InMemoryZLibDecompression::RunSample()
{
    CreateDataBlocks();
    ...
    DX::ThrowIfFailed(s_factory->CreateStatusArray(1, u8"InMemoryZLibDecompression Status Array", __uuidof(DStorageStatusArrayCrossPlatform), (void**)(m_status.ReleaseAndGetAddressOf())));
...
void InMemoryZLibDecompression::CreateDataBlocks()
{
