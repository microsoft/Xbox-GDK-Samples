...
#include "pch.h"
#include "XBoxZLibDecompression.h"

#define VALIDATE_READS

bool XBoxZLibDecompression::RunSample(const std::wstring& fileName, uint32_t zipFileUncompressedSize)
{
    ...
    queueDesc.Name = u8"SimpleDirectStorage: XBoxDecompression";
    ...
    DX::ThrowIfFailed(factory->CreateStatusArray(1, u8"XBoxZLibDecompression Status Array", __uuidof(DStorageStatusArrayCrossPlatform), (void**)(status.ReleaseAndGetAddressOf())));
