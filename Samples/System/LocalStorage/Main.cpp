...
LPCWSTR g_szAppName = L"LocalStorage";
...
int SampleMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"LocalStorageWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"LocalStorageWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
