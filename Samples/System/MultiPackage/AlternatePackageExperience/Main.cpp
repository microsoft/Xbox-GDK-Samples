...
LPCWSTR g_szAppName = L"AlternatePackageExperience";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"AlternatePackageExperienceWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"AlternatePackageExperienceWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
