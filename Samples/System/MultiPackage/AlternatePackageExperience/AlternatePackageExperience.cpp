...
#include "pch.h"
#include "AlternatePackageExperience.h"
...
{
    XLaunchUri(m_userManager->GetUserHandle(), "launchmainpackage://Parameter1=xyz");
}

void Sample::XBOXLiveProtocolLaunch()
{
    XLaunchUri(m_userManager->GetUserHandle(), "ms-xbl-651BDC76://");
}

void Sample::XBOXLiveProtocolPDPLaunch()
{
    // Currently using the store sample as its in the store. If you have already downloaded it, the PDP page will not
    // be opened.
