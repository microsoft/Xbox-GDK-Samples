...
LPCWSTR g_szAppName = L"MainPackageExperience";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"MainPackageExperienceWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"MainPackageExperienceWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
