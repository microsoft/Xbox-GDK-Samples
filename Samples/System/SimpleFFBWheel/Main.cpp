...
LPCWSTR g_szAppName = L"SimpleFFBWheel";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"SimpleFFBWheelWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"SimpleFFBWheelWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
