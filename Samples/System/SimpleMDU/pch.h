...
// Early 2006 QFEs did not defint this value in the dstorage_xs.h header 
#ifndef DSTORAGE_MAX_DESTINATION_SIZE
    #define DSTORAGE_MAX_DESTINATION_SIZE           0x2000000
#endif
