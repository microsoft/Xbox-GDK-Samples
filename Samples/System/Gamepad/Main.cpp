...
// Main.cpp
//
// Window setup and message loop for the Gamepad sample.
//
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE /*hPrevInstance*/, _In_ LPWSTR /*lpCmdLine*/, _In_ int /*nCmdShow*/)
{
    ...
    if (FAILED(hr))
    {
        ...
        {
            std::ignore = MessageBoxW(nullptr, L"Game Runtime is not installed on this system or needs updating.", L"Gamepad", MB_ICONERROR | MB_OK);
        }
#endif
        return 1;
    }
    ...
    WNDCLASSEXW wc = { sizeof(wc), CS_CLASSDC, WndProc, 0L, 0L, hInstance, nullptr, nullptr, nullptr, nullptr, L"Gamepad", nullptr };
    RegisterClassExW(&wc);
    ...
    HWND hWnd = CreateWindowW(wc.lpszClassName, L"Gamepad", WS_OVERLAPPEDWINDOW,
    ...
    io.ConfigFlags &= ~ImGuiConfigFlags_NavEnableGamepad;     // Disable Gamepad Controls (the sample reads the gamepad directly)
    ...
    g_sample->Initialize(hWnd, g_d3dDeviceContext.get());
