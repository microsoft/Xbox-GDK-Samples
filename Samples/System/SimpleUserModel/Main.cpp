...
LPCWSTR g_szAppName = L"Simple User Model";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"SimpleUserModelWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"SimpleUserModelWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
