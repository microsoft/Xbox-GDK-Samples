...
LPCWSTR g_szAppName = L"PIXCircularCaptureCombo";
...
int SampleMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"PIXCircularCaptureComboWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"PIXCircularCaptureComboWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
