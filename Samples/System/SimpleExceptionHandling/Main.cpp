...
LPCWSTR g_szAppName = L"SimpleExceptionHandling";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"SimpleExceptionHandlingWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"SimpleExceptionHandlingWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
