...
LPCWSTR g_szAppName = L"GameInputSequential";
...
int WINAPI SampleMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"GameInputSequentialWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"GameInputSequentialWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
