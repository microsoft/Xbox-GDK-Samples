...
LPCWSTR g_szAppName = L"NLSAndLocalization";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"NLSAndLocalization";
        ...
        HWND hwnd = CreateWindowExW(0, L"NLSAndLocalization", g_szAppName, WS_OVERLAPPEDWINDOW,
