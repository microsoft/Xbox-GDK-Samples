...
LPCWSTR g_szAppName = L"SystemInfo";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"SystemInfoWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"SystemInfoWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
