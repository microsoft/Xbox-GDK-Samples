...
namespace ATG
{
    namespace DataBreak
    {
        ...
        //************************************
        bool SetHardwareBreakPointForThread(void *thread, void *address, DEBUG_REGISTER debugRegister, ADDRESS_OPERATION addressOperation, ADDRESS_SIZE addressSize) noexcept(false);
        ...
        //************************************
        bool ClearHardwareBreakPointForThread(void *thread, DEBUG_REGISTER debugRegister) noexcept(false);
    }
}
