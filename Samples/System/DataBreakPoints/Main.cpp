...
LPCWSTR g_szAppName = L"DataBreakPoints";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"DataBreakPointsWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"DataBreakPointsWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
