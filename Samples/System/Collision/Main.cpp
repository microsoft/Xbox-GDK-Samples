...
LPCWSTR g_szAppName = L"Collision";
...
int SampleMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"CollisionWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"CollisionWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
