...
LPCWSTR g_szAppName = L"InGameChat";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"InGameChatWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"InGameChatWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
