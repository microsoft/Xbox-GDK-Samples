...
private:
    ...
    void XM_CALLCONV DrawRoom(ID3D12GraphicsCommandList* commandList, DirectX::FXMVECTOR color);
    void XM_CALLCONV DrawListener(ID3D12GraphicsCommandList* commandList, DirectX::FXMVECTOR color);
	...
	void LinearTravel(PointSound* inSound);
	void BounceTravel(PointSound* inSound);
	void RoundTravel(PointSound* inSound);
	...
	std::unique_ptr<DirectX::BasicEffect>       m_batchEffectRoom;
	std::unique_ptr<DirectX::BasicEffect>       m_batchEffectListener;
