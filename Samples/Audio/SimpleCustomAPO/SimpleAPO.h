...
class __declspec(uuid("{5EB8D611-FF96-429d-8365-2DDF89A7C1CD}"))
    CSimpleAPO : public CSampleXAPOBase<CSimpleAPO, SimpleAPOParams>
{
public:
    CSimpleAPO();
    ~CSimpleAPO() override;

    CSimpleAPO(CSimpleAPO&&) = default;
    CSimpleAPO& operator= (CSimpleAPO&&) = default;

    CSimpleAPO(CSimpleAPO const&) = delete;
    CSimpleAPO& operator= (CSimpleAPO const&) = delete;
