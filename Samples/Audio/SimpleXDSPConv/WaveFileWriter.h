...
public:
    ...
    // File data
    HRESULT WriteSample(LPVOID pvBuffer, DWORD dwBufferSize, LPDWORD pdwWritten = nullptr);
...
protected:
    ...
    LPBYTE                  m_pvWaveHeader;      // Wave header
...
inline DWORD CWaveFileWriter::GetFormatSize(LPCWAVEFORMATEX pwfxFormat)
{
