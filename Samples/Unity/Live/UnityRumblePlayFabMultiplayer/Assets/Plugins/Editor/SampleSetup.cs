...
{
    static readonly string playFabSdkPackage = "Assets/SDKs/playfab-multiplayer-party.unitypackage";
    ...
    static readonly string gdkPlayFabMultiplayerLibraryPath_240600 = "GRDK/ExtensionLibraries/PlayFab.Multiplayer.Cpp/Redist/CommonConfiguration/neutral";
    ...
    static readonly string gdkPlayFabMultiplayerLibraryPath_241000 = "GRDK/ExtensionLibraries/PlayFab.Multiplayer.Cpp/Redist/x64";
    static readonly string targetPlayFabPartyDllPath = "Assets/PlayFabPartySDK/Source/DLLs/GameCore";
    static readonly string targetPlayFabMultiplayerDllPath = "Assets/PlayFabMultiplayerSDK/Source/DLLs/GDK";
    ...
    private static void UpdatePlayFabDlls()
    {
        ...
        if (!string.IsNullOrEmpty(gdkPath))
        {
            ...
            // Copy PlayFabMultiplayerGDK.dll from GDK install to 'GDK' folder
            sourcePath = $"{gdkPath}{gdkLatestVersion}/{gdkPlayFabMultiplayerLibraryPath_240600}";
            if (gdkLatestVersion >= 241000)
            {
                sourcePath = $"{gdkPath}{gdkLatestVersion}/{gdkPlayFabMultiplayerLibraryPath_241000}";
            }
            sourceName = "PlayFabMultiplayerGDK";
            targetPath = $"{targetPlayFabMultiplayerDllPath}";
            targetName = "PlayFabMultiplayerGDK";
