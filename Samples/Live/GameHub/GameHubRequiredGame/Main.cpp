...
LPCWSTR g_szAppName = L"GameHubRequiredGame";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"GameHubRequiredGameWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"GameHubRequiredGameWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
