...
LPCWSTR g_szAppName = L"GameHubRelatedGame";
...
int SampleMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
    ...
    if (SUCCEEDED(XGameUiShowMessageDialogAsync(ab, u8"GameHubRelatedGame", u8"Attach debugger now!",
...
#endif
    {
        ...
        wcex.lpszClassName = L"GameHubRelatedGameWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"GameHubRelatedGameWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
