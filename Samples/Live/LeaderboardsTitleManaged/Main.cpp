...
LPCWSTR g_szAppName = L"Title-managed Leaderboards";
...
int SampleMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"LeaderboardsTitleManagedWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"LeaderboardsTitleManagedWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
