...
void MenuScreen::ReadCurrentEntry()
{
    if (m_menuEntries.size() > 0)
    {
        Managers::Get<SpeechManager>()->RenderTextToSpeech(m_menuEntries[m_selectedEntry].m_label + m_menuEntries[m_selectedEntry].m_value);
    }
}
