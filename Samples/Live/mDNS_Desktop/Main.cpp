...
LPCWSTR g_szAppName = L"mDNS_Desktop";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
    ...
    // Register class and create window
    {
        ...
        wcex.lpszClassName = L"mDNS_DesktopWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"mDNS_DesktopWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
