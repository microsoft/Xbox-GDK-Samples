...
LPCWSTR g_szAppName = L"SimpleHttp";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"SimpleHttpWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"SimpleHttpWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
