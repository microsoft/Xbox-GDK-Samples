...
LPCWSTR g_szAppName = L"PlayFabLeaderboards";
...
int WINAPI SampleMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"PlayFabLeaderboardsWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"PlayFabLeaderboardsWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
