...
LPCWSTR g_szAppName = L"SimpleWinHttp";
...
int SampleMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"SimpleWinHttpWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"SimpleWinHttpWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
