...
namespace
{
    ...
    const wchar_t* c_authWebAddress = L"https://profile.xboxlive.com/users/me/profile/settings?settings=GameDisplayName";
    ...
    */
    ...
    constexpr int c_connectBtn = 2101;
    constexpr int c_sendMessageBtn = 2102;
    constexpr int c_makeRequestBtn = 2103;
    constexpr int c_xblRequestBtn = 2104;
    constexpr int c_gameServiceBtn = 2105;
}
    ...
    m_lastSocketStatus(ATG::WebSocketStatus::Uninitialized)
{
    ...
    m_liveInfoHUD = std::make_unique<ATG::LiveInfoHUD>("Simple WinHttp Sample");
...
void Sample::Initialize(HWND window, int width, int height)
{
    ...
    m_liveResources->SetUserSignOutCompletedCallback([this](XalUserHandle)
        {
