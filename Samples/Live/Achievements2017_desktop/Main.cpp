...
#include "Achievements2017_desktop.h"
...
LPCWSTR g_szAppName = L"Achievements2017_desktop";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
    ...
    // Register class and create window
    {
        ...
        wcex.lpszClassName = L"Achievements2017_desktopWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"Achievements2017_desktopWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
            CW_USEDEFAULT, CW_USEDEFAULT, rc.right - rc.left, rc.bottom - rc.top, nullptr, nullptr, hInstance,
            nullptr);
        // Change to CreateWindowExW(WS_EX_TOPMOST, L"Achievements2017_desktopWindowClass", g_szAppName, WS_POPUP,
