...
LPCWSTR g_szAppName = L"PlayFabStore";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"PlayFabStoreWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"PlayFabStoreWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
