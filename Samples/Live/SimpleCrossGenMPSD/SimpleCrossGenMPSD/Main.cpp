...
LPCWSTR g_szAppName = L"SimpleCrossGenMPSD";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"SimpleCrossGenMPSDWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"SimpleCrossGenMPSDWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
