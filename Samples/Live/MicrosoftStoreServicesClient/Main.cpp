...
LPCWSTR g_szAppName = L"MicrosoftStoreServicesClient";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"MicrosoftStoreServicesClientWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"MicrosoftStoreServicesClientWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
