...
LPCWSTR g_szAppName = L"SimpleWebSockets";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"SimpleWebSocketsWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"SimpleWebSocketsWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
