...
LPCWSTR g_szAppName = L"SocialManager";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"SocialManagerWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"SocialManagerWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
