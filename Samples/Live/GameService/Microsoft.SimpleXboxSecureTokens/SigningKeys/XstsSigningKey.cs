...
namespace Microsoft.SimpleXboxSecureTokens
{
    ...
    public class XstsSigningKey
    {
        ...
        /// <summary>
        /// Returns the correct RSA provider for the current platform.  RSACng() for Windows and RSAOpenSsl() for Unix-based platforms.
        /// </summary>
        /// <returns></returns>
        /// <exception cref="PlatformNotSupportedException"></exception>
        public static RSA GetRSAProviderForPlatform()
        {
            return Environment.OSVersion.Platform switch
            {
                PlatformID.Unix => new RSAOpenSsl(),

                PlatformID.Win32NT or
                PlatformID.Win32S or
                PlatformID.Win32Windows or
                PlatformID.WinCE => new RSACng(),

                _ => throw new PlatformNotSupportedException($"Unable to resolve an RSA Cryptography Provider for platform {Environment.OSVersion.Platform}.")
            };
        }
    }
}
