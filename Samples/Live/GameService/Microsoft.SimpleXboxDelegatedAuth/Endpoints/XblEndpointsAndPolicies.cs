...
{
    /// <summary>
    /// Caching and special case rules for endpoints to generate signatures
    ...
    public class XblEndpointsAndPolicies
    {
        ...
        /// <summary>
        /// Retrieves the XBL mapping of endpoint to relying party and signature policies
        /// </summary>
        /// <returns></returns>
    ...
    /// <summary>
    /// XblEndpoint represents an Xbox Live service endpoint that your service can call with Delegated Auth Xtokens
    /// </summary>
    public class XblEndpoint
    {
        ...
        {
            // if we have a fully qualified domain-name match 
    ...
    /// <summary>
    /// Signature policy for the Xbox Live services
    /// </summary>
