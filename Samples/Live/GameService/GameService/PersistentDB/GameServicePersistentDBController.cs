//-----------------------------------------------------------------------------
// GameServicePersistentDBController.cs
//
...
namespace GameService
{
    public static class GameServicePersistentDBController
    {
        ...
        public static GameServicePersistentDBContext CreateDbContext(IConfiguration Config, CorrelationVector mCv, ILogger mLogger)
        {
            var optionsBuilder = new DbContextOptionsBuilder<GameServicePersistentDBContext>();
            ...
            if (string.IsNullOrEmpty(connectionString))
            {
                ...
                mLogger.StartupInfo(mCv.Value, "Using in-memory database for Game Service, for a production service this should be a persistent DB.");
            }
            else
            {
            ...
            return new GameServicePersistentDBContext(optionsBuilder.Options);
        }
    }
}
