...
LPCWSTR g_szAppName = L"PlayFabMultiplayerRumble";
...
int SampleMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"PlayFabMultiplayerRumbleWindowClass";
...
#endif
        HWND hwnd = CreateWindowExW(0, L"PlayFabMultiplayerRumbleWindowClass", g_szAppName, WS_OVERLAPPED | WS_MINIMIZEBOX | WS_SYSMENU,
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
    ...
    switch (message)
    {
     ...
     case WM_XBUTTONUP:
     case WM_MOUSEHOVER:
         //Mouse::ProcessMessage(message, wParam, lParam); // TODO: Add mouse
         break;
