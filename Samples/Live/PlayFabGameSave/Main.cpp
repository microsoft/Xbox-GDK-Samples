...
LPCWSTR g_szAppName = L"PlayFabGameSave";
...
int WINAPI SampleMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"PlayFabGameSaveWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"PlayFabGameSaveWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
