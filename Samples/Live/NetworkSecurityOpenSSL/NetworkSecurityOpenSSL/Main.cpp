...
LPCWSTR g_szAppName = L"NetworkSecurityOpenSSL";
...
int SampleMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"NetworkSecurityOpenSSLWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"NetworkSecurityOpenSSLWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
