...
LPCWSTR g_szAppName = L"Social_desktop";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE hPrevInstance, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
    ...
    // Register class and create window
    {
        ...
        wcex.lpszClassName = L"SocialWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"SocialWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
            CW_USEDEFAULT, CW_USEDEFAULT, rc.right - rc.left, rc.bottom - rc.top, nullptr, nullptr, hInstance,
            nullptr);
        // Change to CreateWindowExW(WS_EX_TOPMOST, L"SocialWindowClass", g_szAppName, WS_POPUP,
