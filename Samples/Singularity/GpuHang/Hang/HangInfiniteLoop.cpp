...
public:
    ...
    virtual void Initialize(ID3D12Device* device, ID3D12CommandQueue* /*commandQueue*/) override
    {
        ...
        DX::ThrowIfFailed(device->CreateComputePipelineState(&descPipelineState, IID_PPV_ARGS(m_pipelineState.ReleaseAndGetAddressOf())));
...

        {
            ...
            DX::ThrowIfFailed(
                device->CreateCommittedResource(&uploadHeapProperties,
                    ...
                    nullptr,
                    IID_PPV_ARGS(m_bufInput.ReleaseAndGetAddressOf())));
            ...
            DX::ThrowIfFailed(
                device->CreateCommittedResource(&defaultHeapProperties,
                    ...
                    nullptr,
                    IID_PPV_ARGS(m_bufOutput.ReleaseAndGetAddressOf())));
        }
    }
