...
LPCWSTR g_szAppName = L"OSPrimitiveTestCombo";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"OSPrimitiveTestComboWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"OSPrimitiveTestComboWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
