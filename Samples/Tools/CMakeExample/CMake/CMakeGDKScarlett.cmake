...
if (NOT DEFINED VCInstallDir)
    ...
    if(XdkEditionTarget GREATER_EQUAL 260400)
        if (MSVC_TOOLSET_VERSION MATCHES "145")
            set(GDK_VS_YEARS "2026")
        else()
            set(GDK_VS_YEARS "2022" "2026")
        endif()
    else()
        set(GDK_VS_YEARS "2022")
    endif()

    foreach(vsyear IN LISTS GDK_VS_YEARS)
        foreach(vsedition IN LISTS GDK_VS_EDITIONS)
            cmake_path(SET VCInstallDir "$ENV{ProgramFiles}/Microsoft Visual Studio/${vsyear}/${vsedition}/VC")
...
if(XdkEditionTarget GREATER_EQUAL 251000)
    set(Console_EndpointIncludeRoot
        ...
        "${DurangoXdkInstallPath}/xbox/include/gen9")
else()
    set(Console_EndpointIncludeRoot
...
if(XdkEditionTarget GREATER_EQUAL 251000)
    set(Console_EndpointLibRoot
        ...
        "${DurangoXdkInstallPath}/xbox/lib/gen9")
else()
    set(Console_EndpointLibRoot
...
if (EXISTS "${VCInstallDir}/redist/MSVC/${VCToolsRedistVersion}/onecore/x64/Microsoft.VC${MSVC_TOOLSET_VERSION}.CRT")
    set(CRTPlatformToolset ${MSVC_TOOLSET_VERSION})
else()
    set(CRTPlatformToolset 145)
endif()
...
if(XdkEditionTarget GREATER_EQUAL 251000)
    find_program(DIRECTX_DXC_TOOL dxc.exe
        REQUIRED NO_SYSTEM_ENVIRONMENT_PATH NO_CMAKE_SYSTEM_PATH NO_DEFAULT_PATH
        HINTS "${DurangoXdkInstallPath}/xbox/bin/gen9")
else()
    find_program(DIRECTX_DXC_TOOL dxc.exe
        REQUIRED NO_SYSTEM_ENVIRONMENT_PATH NO_CMAKE_SYSTEM_PATH NO_DEFAULT_PATH
