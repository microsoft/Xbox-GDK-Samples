...
if(Console_SdkRoot AND XdkEditionTarget)
    if(EXISTS "${Console_SdkRoot}/${XdkEditionTarget}")
        set(CMAKE_CXX_FLAGS_INIT "${CMAKE_CXX_FLAGS_INIT} /I\"${Console_SdkRoot}/${XdkEditionTarget}/xbox/include\" /I\"${Console_SdkRoot}/${XdkEditionTarget}/xbox/include/gen9\"" CACHE STRING "" FORCE)
        
        # Add GDK library paths
        foreach(t EXE SHARED MODULE)
            string(APPEND CMAKE_${t}_LINKER_FLAGS_INIT " /LIBPATH:\"${Console_SdkRoot}/${XdkEditionTarget}/xbox/lib/x64\" /LIBPATH:\"${Console_SdkRoot}/${XdkEditionTarget}/xbox/lib/gen9\"")
        endforeach()
    endif()
endif()
...
set(CMAKE_VS_GLOBALS "XdkEditionTarget=${XdkEditionTarget};GDKCrossPlatform=true" CACHE STRING "" FORCE)
...
if(NOT GDK_DXCTool)
  ...
  find_program(
        GDK_DXCTool
        NAMES dxc
        PATHS "${Console_SdkRoot}/${XdkEditionTarget}/xbox/bin/gen9"
        )
