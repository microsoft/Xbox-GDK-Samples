...
void Sample::PerformTests()
{
    ...
    if (ATG::IsSMTSupported())
    {
        ...
        coreMasks.push_back(0);
        coreMasks.push_back(0x3fef);
        coreTestNames.push_back(L"Single Core");
        coreTestNames.push_back(L"Same physical");
        coreTestNames.push_back(L"Same Cluster");
        coreTestNames.push_back(L"Cross Cluster");
        coreTestNames.push_back(L"All Cores Non-SMT");
        coreTestNames.push_back(L"All Cores SMT");
    }
    else
    {
        coreMasks.push_back(0x01);
        coreMasks.push_back(0x00);
        coreMasks.push_back(0x03);
        coreMasks.push_back(0x11);
        coreMasks.push_back(0x7e);
        coreMasks.push_back(0x0);
        coreTestNames.push_back(L"Single Core");
        coreTestNames.push_back(L"Same physical");
        coreTestNames.push_back(L"Same Cluster");
        coreTestNames.push_back(L"Cross Cluster");
...
void Sample::Render()
{
    ...
    if (m_timer.GetFrameCount() > 3)
    {
        ...
        else
        {
            ...
            outputString += m_testRunningOutputText;
        }
