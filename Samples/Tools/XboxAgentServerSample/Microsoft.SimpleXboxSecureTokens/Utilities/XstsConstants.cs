...
namespace Microsoft.SimpleXboxSecureTokens
{
    ...
    static public class XstsConstants
    {
        ...
        public const string ServiceName = "GameServiceSample_v2207";
        public const string CacheKeyFormat = "{0}:{1}:{2}";
        public const string BPCertThumbprintKey = "BP_CERT_THUMBPRINT";
        public const string RPCertThumbprintKey = "RP_CERT_THUMBPRINT";
