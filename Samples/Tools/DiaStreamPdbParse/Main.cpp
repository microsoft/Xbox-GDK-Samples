...
LPCWSTR g_szAppName = L"DiaStreamPdbParse";
...
int SampleMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
    ...
    // Initialize COM for DIA usage, only need this on Desktop, Console accesses the DLL directly
...
#endif
    {
        ...
        wcex.lpszClassName = L"DiaStreamPdbParseWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"DiaStreamPdbParseWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
