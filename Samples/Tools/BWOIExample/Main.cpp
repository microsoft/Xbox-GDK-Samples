...
LPCWSTR g_szAppName = L"BWOIExample";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"BWOIExampleWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"BWOIExampleWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
