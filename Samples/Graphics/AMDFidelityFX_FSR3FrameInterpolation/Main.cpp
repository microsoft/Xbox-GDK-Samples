...
LPCWSTR g_szAppName = L"FidelityFX FSR3 Frame Interpolation";
LPCWSTR g_szWndCassName = L"FidelityFXSFSR3FrameInterpolationWindowClass";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#ifndef _GAMING_XBOX
    // SetStablePowerState workaround
...

    {
        ...
        wcex.lpszClassName = g_szWndCassName;
        ...
        // Create window
        HWND hwnd = CreateWindowExW(0, g_szWndCassName, g_szAppName, WS_OVERLAPPEDWINDOW,
