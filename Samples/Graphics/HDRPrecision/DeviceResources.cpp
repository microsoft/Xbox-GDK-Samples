...
//
// Modified require Xbox Series X|S, to expose a UAV for the swap buffer, and custom format/colorspace control.
//
...
void DeviceResources::CreateWindowSizeDependentResources(DXGI_FORMAT swapBufferFormat)
{
    if (!m_window)
    {
    ...
    m_backBufferFormat = swapBufferFormat;
...
void DeviceResources::Present(DXGI_COLOR_SPACE_TYPE colorSpaceType, D3D12_RESOURCE_STATES beforeState, _In_opt_ const D3D12XBOX_PRESENT_PARAMETERS* params)
{
    ...
    planeParameters.ColorSpace = colorSpaceType;
