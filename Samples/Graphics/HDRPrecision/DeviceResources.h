...
namespace DX
{
    ...
    public:
        ...
        void CreateWindowSizeDependentResources(DXGI_FORMAT swapBufferFormat);
        void SetWindow(HWND window) noexcept { m_window = window; }
        void Prepare(D3D12_RESOURCE_STATES beforeState = D3D12_RESOURCE_STATE_PRESENT,
                     D3D12_RESOURCE_STATES afterState = D3D12_RESOURCE_STATE_RENDER_TARGET);
        void Present(DXGI_COLOR_SPACE_TYPE colorSpaceType,
        ...
        CD3DX12_GPU_DESCRIPTOR_HANDLE GetSwapBufferUAV() const noexcept
        {
            return CD3DX12_GPU_DESCRIPTOR_HANDLE(
                m_uavDescriptorHeap->GetGPUDescriptorHandleForHeapStart(),
                static_cast<INT>(m_backBufferIndex), m_uavDescriptorSize);
        }
