...
DeviceResources::DeviceResources(
    ...
    unsigned int flags) noexcept(false) :
        ...
        m_gameDVRFormat(backBufferFormat),
#endif
...
#else
    rtvDescriptorHeapDesc.NumDescriptors = m_backBufferCount * 2;
#endif
...
void DeviceResources::CreateWindowSizeDependentResources()
{
    ...
    CD3DX12_CLEAR_VALUE swapChainOptimizedClearValue(m_backBufferFormat, m_clearColor);
...
void DeviceResources::Present(D3D12_RESOURCE_STATES beforeState)
{
    ...
    ThrowIfFailed(
        m_commandQueue->PresentX(2, planeParameters, nullptr)
    );
