...
LPCWSTR g_szAppName = L"SimplePBR";
...
int SampleMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"SimplePBRWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"SimplePBRWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
