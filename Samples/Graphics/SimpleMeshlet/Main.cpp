...
LPCWSTR g_szAppName = L"SimpleMeshlet";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"SimpleMeshletWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"SimpleMeshletWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
