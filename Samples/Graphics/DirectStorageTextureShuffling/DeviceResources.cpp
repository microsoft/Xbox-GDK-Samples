...
void DeviceResources::Present(ID3D12Fence* pUnshuffleTextureFence, UINT64 unshuffleTextureFenceValue, D3D12_RESOURCE_STATES beforeState, _In_opt_ const D3D12XBOX_PRESENT_PARAMETERS* params)
{
    ...
    // Signal that the GPU is done with the texture shuffling data
    m_commandQueue->Signal(pUnshuffleTextureFence, unshuffleTextureFenceValue);
...
{
    PIXScopedEvent(PIX_COLOR_DEFAULT, L"WaitForGpu");
