...
LPCWSTR g_szAppName = L"VRSAndSparseLighting";
...
int SampleMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"VRSWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"VRSWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
