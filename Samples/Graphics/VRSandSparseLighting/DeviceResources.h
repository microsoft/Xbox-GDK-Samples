...
//
// Modified to use ID3D12Device6/ID3D12GraphicsCommandList5 to support VRS,
// and access to all render targets.
//
...
namespace DX
{
    ...
    public:
        ...
        ID3D12Resource*             GetRenderTarget(UINT index) const noexcept { return m_renderTargets[index].Get(); }
