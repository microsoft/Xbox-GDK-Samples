...
LPCWSTR g_szAppName = L"DXRTriangle";
...
int SampleMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"DXRTriangleWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"DXRTriangleWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
