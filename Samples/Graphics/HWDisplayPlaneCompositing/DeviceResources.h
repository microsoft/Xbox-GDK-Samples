...
namespace DX
{
    ...
    public:
        ...
        DeviceResources(DXGI_FORMAT sceneBackBufferFormat = DXGI_FORMAT_B8G8R8A8_UNORM,
                        DXGI_FORMAT uiBackBufferFormat = DXGI_FORMAT_B8G8R8A8_UNORM,
        ...
        ID3D12Resource*             GetSceneRenderTarget() const noexcept  { return m_sceneRenderTargets[m_backBufferIndex].Get(); }
        ID3D12Resource*             GetUIRenderTarget() const noexcept     { return m_uiRenderTargets[m_backBufferIndex].Get(); }
        ...
        DXGI_FORMAT                 GetSceneBackBufferFormat() const noexcept   { return m_sceneBackBufferFormat; }
        ...
        CD3DX12_CPU_DESCRIPTOR_HANDLE GetSceneRenderTargetView() const noexcept
        {
        ...
        CD3DX12_CPU_DESCRIPTOR_HANDLE GetUIRenderTargetView() const noexcept
        {
            ...
            return CD3DX12_CPU_DESCRIPTOR_HANDLE(
                m_rtvDescriptorHeap->GetCPUDescriptorHandleForHeapStart(),
                static_cast<INT>(uiStartIndex + m_backBufferIndex), m_rtvDescriptorSize);
        }
    ...
    private:
        ...
        // Swap chain objects.
        Microsoft::WRL::ComPtr<ID3D12Resource>              m_sceneRenderTargets[MAX_BACK_BUFFER_COUNT];
        ...
        // Direct3D properties.
        DXGI_FORMAT                                         m_sceneBackBufferFormat;
