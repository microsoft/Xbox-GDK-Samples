...
namespace
{
	...
	static const int g_NumStalkParticles = 500;
	static const int g_NumGroundBurstParticles = 345;
	static const int g_NumMushroomParticles = 200;

	static const int g_MaxMushroomClouds = 8;

	static const float g_ParticleSpread = 4.0f;
	static const float g_ParticleStartSize = 0.0f;
	static const float g_ParticleEndSize = 10.0f;
	static const float g_ParticleSizeExponent = 128.0f;

	static const float g_ParticleMushroomCloudLifeSpan = 10.0f;
	static const float g_ParticleGroundBurstLifeSpan = 9.0f;

	static const float g_ParticleMushroomStartSpeed = 20.0f;
	static const float g_ParticleStalkStartSpeed = 50.0f;
	static const float g_ParticleGroundBurstStartSpeed = 100.0f;

	static const float g_ParticleEndSpeed = 4.0f;
	static const float g_ParticleSpeedExponent = 32.0f;
	static const float g_ParticleFadeExponent = 4.0f;
	static const float g_ParticleRollAmount = 0.2f;
	static const float g_ParticleWindFalloff = 20.0f;

	static const float g_ParticleLightRaise = 1.0f;

	static const int  g_MaxFlashColors = 4;
	...
	static const float g_FlashLife = 0.50f;
	static const float g_FlashIntensity = 1000.0f;
