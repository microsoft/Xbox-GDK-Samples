...
LPCWSTR g_szAppName = L"VisibilityBuffer";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"VisibilityBufferWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"VisibilityBufferWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
...
#ifdef _GAMING_XBOX
        Mouse::SetResolution(rc.right == 3840 ? 2.f : 1.f);
