...
LPCWSTR g_szAppName = L"AdvancedLighting";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"AdvancedLightingWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"AdvancedLightingWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
