...
#ifndef SHADING_RATE
#error SHADING_RATE must be #defined
#endif
...
void main(point Empty Points[1], inout TriangleStream<InterpolantsTexcoord> Stream)
{
    ...
    {
        { { -1.0f, -1.0f, 1.0f, 1.0f, }, {  0.0f, +1.0f, }, SHADING_RATE, },
        { { -1.0f, +3.0f, 1.0f, 1.0f, }, {  0.0f, -1.0f, }, SHADING_RATE, },
        { { +3.0f, -1.0f, 1.0f, 1.0f, }, { +2.0f, +1.0f, }, SHADING_RATE, }, 
    };
