...
LPCWSTR g_szAppName = L"HLSLSymbols";
...
int SampleMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...

    {
        ...
        wcex.lpszClassName = L"HLSLSymbolsWindowClass";
        ...
        // Create window
        HWND hwnd = CreateWindowEx(0, L"HLSLSymbolsWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
