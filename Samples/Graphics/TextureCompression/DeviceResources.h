...
//
// Modified to require Xbox Series X|S, use older present style, and expose present fences
//
...
namespace DX
{
    ...
    public:
        ...
        UINT64                      GetCurrentFenceValue() const noexcept  { return m_fenceValues[m_backBufferIndex]; }
        UINT64                      GetRetiredFenceValue() const noexcept  { return m_retiredFenceValue; }
