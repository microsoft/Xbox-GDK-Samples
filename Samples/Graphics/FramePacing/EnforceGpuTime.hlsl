...
//
// This compute shader creates a repeatable GPU workload by spinning until a specified
// time has passed. FramePacing uses it to demonstrate changing graphics and compute load.
//
