...
LPCWSTR g_szAppName = L"Meshlet Instancing";
...
int SampleMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"MeshletInstancingWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"MeshletInstancingWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
