...
namespace DX
{
    ...
    public:
        ...
        // SetFrameIntervalX method added to interface
        void SetFrameIntervalX(UINT LengthInMicroseconds, UINT PeriodInIntervals, UINT IntervalOffsetInMicroseconds = 0u, D3D12XBOX_FRAME_INTERVAL_FLAGS flags = D3D12XBOX_FRAME_INTERVAL_FLAG_NONE);

        HRESULT GetFrameStatisticsX(
            UINT previousFrame,
        ...
        void SetBackBufferCountLimiter(UINT limit) noexcept { m_backBufferCountLimiter = limit; }
    ...
    private:
        ...
        static constexpr size_t MAX_FRAME_STATISTICS  = 10;
        ...
        D3D12XBOX_FRAME_PIPELINE_TOKEN                      m_pastFramePipelineTokens[MAX_FRAME_STATISTICS];
        UINT                                                m_pastFramePipelineTokenIndex;
