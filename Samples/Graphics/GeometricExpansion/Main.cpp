...
LPCWSTR g_szAppName = L"GeometricExpansion";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"GeometricExpansionWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"GeometricExpansionWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
