...
LPCWSTR g_szAppName = L"RasterOrderViews";
...
int SampleMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"RasterOrderViewsWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"RasterOrderViewsWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
