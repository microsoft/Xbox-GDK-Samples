...
void DeviceResources::CreateDeviceResources()
{
    ...
    params.pDXRStackBuffer = D3D12_GPU_VIRTUAL_ADDRESS_UNKNOWN; // Disable driver allocated DXR scratch for scarlett.
    params.CreateDeviceFlags = D3D12XBOX_CREATE_DEVICE_FLAG_NONE;

#if (_GRDK_VER < 0x585D10B0 /* March 2023 (plus updates) and earlier */)
    // A bug was found which made it so the driver validation incorrectly reported that compute
    // scratch is needed for dispatch ray calls. This was fixed and brought back to June 2023. Since
    // this sample supports until March, this one line workaround is necessary.
    ...
    if (m_options & (c_Enable4K_UHD | c_EnableQHD))
    {
        ...
        case XSystemDeviceType::XboxScarlettLockhart /* Xbox Series S */:
            ...
            m_consoleType = ConsoleType::LOCKHART;
        ...
        case XSystemDeviceType::XboxScarlettAnaconda /* Xbox Series X */:
            m_consoleType = ConsoleType::ANACONDA;
            [[fallthrough]];
