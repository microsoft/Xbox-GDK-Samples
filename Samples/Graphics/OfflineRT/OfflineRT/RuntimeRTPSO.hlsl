...
TriangleHitGroup RuntimeRTPSO_HitGroup =
{
    "",                             // AnyHit
    "RuntimeRTPSO_ClosestHitShader" // ClosestHit
};

RaytracingShaderConfig  RuntimeRTPSO_ShaderConfig =
{
    16,                             // Max payload size (sizeof(RayPayload))
    8                               // Max attribute size (sizeof(BuiltInTriangleIntersectionAttributes))
};

RaytracingPipelineConfig RuntimeRTPSO_PipelineConfig =
{
...
void RuntimeRTPSO_RayGenShader()
{
...
[shader("closesthit")]
void RuntimeRTPSO_ClosestHitShader(inout RayPayload payload, in BuiltInTriangleIntersectionAttributes attr)
{
    // Load index buffer
    ...
    float4 albedoColor = g_materialCB.albedo;
...
[shader("miss")]
void RuntimeRTPSO_MissShader(inout RayPayload payload)
{
