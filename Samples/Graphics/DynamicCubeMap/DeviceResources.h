...
namespace DX
{
    ...
    public:
        ...
        void WaitForOrigin();
        void ExecuteCommandListAndReuse();
        void ExecuteComputeCommandList();
        void GraphicsWaitOnCompute();
        void ComputeWaiteOnGraphics();
        ...
        ID3D12CommandQueue*         GetComputeCommandQueue() const noexcept { return m_computeCommandQueue.Get(); }
        ID3D12CommandAllocator*     GetCommandAllocator() const noexcept   { return m_commandAllocators[m_backBufferIndex].Get(); }
        ID3D12CommandAllocator*     GetComputeCommandAllocator() const noexcept { return m_computeCommandAllocators[m_backBufferIndex].Get(); }
        auto                        GetCommandList() const noexcept        { return m_commandList.Get(); }
        auto                        GetComputeCommandList() const noexcept { return m_computeCommandList.Get(); }
    ...
    private:
        ...
        Microsoft::WRL::ComPtr<ID3D12GraphicsCommandList6>  m_computeCommandList;
#else
        ...
        Microsoft::WRL::ComPtr<ID3D12CommandAllocator>      m_computeCommandAllocators[MAX_BACK_BUFFER_COUNT];
