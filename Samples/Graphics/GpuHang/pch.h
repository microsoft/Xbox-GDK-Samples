...
#if (defined(_GAMING_XBOX_SCARLETT) && (_GXDK_VER >= 0x4A611B35 /* GXDK Edition 210600 */))
#define HIX_BLOB_SUPPORT
#endif

#if (defined(_GAMING_XBOX_SCARLETT) && (_GXDK_VER >= 0x585D0BCF /* GXDK Edition 230300 */))
#define HIX_EXCEPTION_SUPPORT
#endif

#if (defined(_GAMING_XBOX_SCARLETT) && (_GXDK_VER >= 0x585D0BCF /* GXDK Edition 230300 */))
#define LIVE_DEBUGGING_SUPPORT
#endif
