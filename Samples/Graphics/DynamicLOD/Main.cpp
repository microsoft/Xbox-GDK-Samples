...
LPCWSTR g_szAppName = L"Dynamic LOD";
...
int WINAPI wWinMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"DynamicLODWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"DynamicLODWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
