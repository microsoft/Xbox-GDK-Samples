...
namespace DX
{
    ...
    public:
        ...
        static constexpr unsigned int MAX_THREADS_BVH_BUILD = 8;
        ...
        void WaitForOrigin();
        void PrepareBVHCommandLists();
        void ExecuteBVHCommandLists();
        ...
        auto                        GetBVHCommandList(unsigned int t)      { return m_commandListsBVH[t].Get(); }
    ...
    private:
        ...
        Microsoft::WRL::ComPtr<ID3D12GraphicsCommandList6>  m_commandListsBVH[MAX_THREADS_BVH_BUILD];
        Microsoft::WRL::ComPtr<ID3D12CommandAllocator>      m_commandAllocatorsBVH[MAX_BACK_BUFFER_COUNT][MAX_THREADS_BVH_BUILD];
