...
LPCWSTR g_szAppName = L"ShadowMapSample";
...
int SampleMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"ShadowMapSampleWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"ShadowMapSampleWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
