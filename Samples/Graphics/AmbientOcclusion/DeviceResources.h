...
namespace DX
{
    ...
    public:
        ...
        void*                       GetDepthTexAddress() const noexcept    { return m_pDepthTextureAddress; }
        XG_RESOURCE_LAYOUT          GetDepthLayout() const noexcept        { return m_depthBufferLayout; }
        XG_TEXTURE_LAYOUT           GetDepthTileMode() const noexcept      { return m_depthTileMode; }
    ...
    private:
        ...
        void*                                               m_pDepthTextureAddress;
        XG_RESOURCE_LAYOUT                                  m_depthBufferLayout;
        XG_TEXTURE_LAYOUT                                   m_depthTileMode;
