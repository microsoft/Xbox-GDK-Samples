...
private:
    ...
    public:
        ...
        void Initialize(ID3D12Device* device) override
        {
            ...
            D3D12_COMPARISON_FUNC cmpFunc = D3D12_COMPARISON_FUNC_NONE;
            if (m_sampleParams.m_type == SAMPLE_CMP ||
                m_sampleParams.m_type == SAMPLE_CMP_LEVEL_ZERO)
            {
                filter = D3D12_FILTER_COMPARISON_MIN_MAG_MIP_POINT;
                cmpFunc = D3D12_COMPARISON_FUNC_ALWAYS;
            }
            ...
            D3D12_SAMPLER_DESC descSampler =
            {
                ...
                0.0f,                                           // FLOAT MipLODBias;
                1U,                                             // UINT MaxAnisotropy;
                cmpFunc,                                        // D3D12_COMPARISON_FUNC ComparisonFunc;
                {},                                             // FLOAT BorderColor[ 4 ];
                0.0f,                                           // FLOAT MinLOD;
                0.0f                                            // FLOAT MaxLOD;
            };
