...
LPCWSTR g_szAppName = L"GpuBench";
...
int WINAPI SampleMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"GpuBenchWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"GpuBenchWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
