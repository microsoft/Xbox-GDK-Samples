...
//
// Updated to support HDR on Xbox, swapchain backbuffer access, and ResetCommandList
//
...
namespace DX
{
    ...
    public:
        ...
        #ifdef _GAMING_XBOX
        void Present(D3D12_RESOURCE_STATES beforeState = D3D12_RESOURCE_STATE_RENDER_TARGET, _In_opt_ const D3D12XBOX_PRESENT_PARAMETERS* params = nullptr);
        #else
