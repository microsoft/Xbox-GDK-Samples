...
LPCWSTR g_szAppName = L"TemporalAntialiasing";
...
int SampleMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"ERASEWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"ERASEWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
