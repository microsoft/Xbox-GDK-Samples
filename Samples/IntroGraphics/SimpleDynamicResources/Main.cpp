...
LPCWSTR g_szAppName = L"DynamicResources";
...
int SampleMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"DynamicResourcesWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"DynamicResourcesWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
