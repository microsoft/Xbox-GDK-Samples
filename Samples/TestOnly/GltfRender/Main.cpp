...
LPCWSTR g_szAppName = L"GltfRender";
...
int SampleMain(_In_ HINSTANCE hInstance, _In_opt_ HINSTANCE, _In_ LPWSTR lpCmdLine, _In_ int nCmdShow)
{
...
#endif
    {
        ...
        wcex.lpszClassName = L"GltfRenderWindowClass";
        ...
        HWND hwnd = CreateWindowExW(0, L"GltfRenderWindowClass", g_szAppName, WS_OVERLAPPEDWINDOW,
