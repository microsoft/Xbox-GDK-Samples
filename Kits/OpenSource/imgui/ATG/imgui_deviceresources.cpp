...
#include "pch.h"
#include "imgui_deviceresources.h"
...
#endif
{
    ...
    // Create a descriptor heap for SRV.
    D3D12_DESCRIPTOR_HEAP_DESC srvDescriptorHeapDesc = {};
    srvDescriptorHeapDesc.NumDescriptors = 64;
    srvDescriptorHeapDesc.Type = D3D12_DESCRIPTOR_HEAP_TYPE_CBV_SRV_UAV;
    srvDescriptorHeapDesc.Flags = D3D12_DESCRIPTOR_HEAP_FLAG_SHADER_VISIBLE;

    ThrowIfFailed(m_d3dDevice->CreateDescriptorHeap(&srvDescriptorHeapDesc, IID_GRAPHICS_PPV_ARGS(m_srvDescriptorHeap.ReleaseAndGetAddressOf())));
...
{
#ifdef _GAMING_XBOX
    m_colorSpace = g_HDRMode ? DXGI_COLOR_SPACE_RGB_FULL_G2084_NONE_P2020 : DXGI_COLOR_SPACE_RGB_FULL_G22_NONE_P709;
#else // _GAMING_DESKTOP
