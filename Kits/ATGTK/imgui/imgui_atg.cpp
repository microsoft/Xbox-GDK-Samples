...
namespace ImGuiAtg
{
    ...
    static void DrawLogContent(LogState& s, const char* headerLabel, float height)
    {
        ImGui::PushID(&s);
    ...
    void DrawLog(const char* title, float /*filterWidth*/)
    {
        ImGui::Begin(title, nullptr, ImGuiWindowFlags_NoCollapse);
        DrawLogContent(GetState(), "Log", 0);
        ImGui::End();
    }

    void DrawLogPanel(float height)
    {
        DrawLogContent(GetState(), "Log", height);
    }
    ...
    void DrawNamedLog(const char* title, const char* id, float /*filterWidth*/)
    {
        ImGui::Begin(title, nullptr, ImGuiWindowFlags_NoCollapse);
        DrawLogContent(GetState(id), id, 0);
        ImGui::End();
    }

    void DrawNamedLogPanel(const char* id, float height)
    {
        DrawLogContent(GetState(id), id, height);
    }
