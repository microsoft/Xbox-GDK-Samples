...
// For samples this will happen automatically from the pch file
#include <chrono>
#include <cmath>
#include <cstdint>
#include <exception>
...
namespace ATG
{
    ...
    ///          Can be used in all C++ thread interfaces
    //////////////////////////////////////////////////////////////////////////
    template<int32_t initialCount, int32_t maximumCount>
    ...
    public:
        ...
        void wait() { lock(); }
        void signal(int32_t postCount = 1) { unlock(postCount); }
        void post(int32_t postCount = 1) { unlock(postCount); }
    ...
    //////////////////////////////////////////////////////////////////////////
    /// \brief SRWSharedLockable
    /// \details ATG::SRWSharedLockable
    /// \details Wraps a Windows Slim Reader/Writer object and implements the C++ concept SharedLockable
    ///          Can be used in all C++ thread interfaces
    //////////////////////////////////////////////////////////////////////////
    class SRWSharedLockable
    {
    private:
        SRWLOCK m_srw;

    public:
        SRWSharedLockable(const SRWSharedLockable&) = delete;
        SRWSharedLockable& operator=(const SRWSharedLockable&) = delete;
        SRWSharedLockable(SRWSharedLockable&& rhs) = delete;
